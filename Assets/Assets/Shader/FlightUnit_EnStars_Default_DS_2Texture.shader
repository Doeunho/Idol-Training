Shader "FlightUnit/EnStars/Default_DS_2Texture" {
	Properties {
		[HideInInspector] _Color ("Base Color", Vector) = (1,1,1,1)
		[Header(Base Color)] _MainTex ("Base Color Map", 2D) = "white" {}
		[NoScaleOffset] _MainTexBack ("Base Color Map (Back)", 2D) = "white" {}
		...
		[NoScaleOffset] _MRSTextureBack ("MRS (Back)", 2D) = "black" {}
		...
		[NoScaleOffset] _MaskTextureBack ("Double Toon Mask (Back)", 2D) = "black" {}
		...
		[NoScaleOffset] _ShadowColorMapBack ("Shadow Color Map (Back)", 2D) = "black" {}
		...
		[NoScaleOffset] _ReflectionMaskTextureBack ("Reflection Mask (Back)", 2D) = "black" {}
		...
		[NoScaleOffset] _SpecularTextureBack ("Specular Color Map (Back)", 2D) = "black" {}
		...
		[Toggle(ENABLE_BACKFACE_RIM_LIGHT)] _EnableBackFaceRimLight ("Back Face Rim Light", Float) = 1
		...
		[NoScaleOffset] _RimLightMaskTextureBack ("Rim Light Mask (Back)", 2D) = "white" {}
		...
		[NoScaleOffset] _EmissiveMapBack ("Emissive Map (Back)", 2D) = "black" {}
